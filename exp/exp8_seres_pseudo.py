...
PSEUDO_PATH = "../input/kaggle-days-ensemble/exp4.csv"
...
def main():
    ...
    with timer('create model'):
        model = CnnModel(num_classes=N_CLASSES, encoder="se_resnext101_32x4d",
                         pretrained="../input/pytorch-pretrained-models/se_resnext101_32x4d-3b2fe3d8.pth",
                         pool_type="avg")
