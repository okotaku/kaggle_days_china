...
from trainer import train_one_epoch_mixup, validate, predict
...
def main():
    ...
    with timer('train'):
        ...
        for epoch in range(1, epochs + 1):
            ...
            tr_loss = train_one_epoch_mixup(model, train_loader, criterion, optimizer, device, N_CLASSES, mixup_prob=0.3)
